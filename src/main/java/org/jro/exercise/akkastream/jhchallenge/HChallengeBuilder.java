...
public class HChallengeBuilder {
	...
	public static <Mat2> Graph<ClosedShape, Mat2> createParallelScanGraph(HChallenge challenge, int par, Sink<Tuple2<String, byte[]>, Mat2> sink) {
		/* TODO 3.4: create a graph with a source, parallel flows, and a sink. Don't forget that "par" argument is the number of parallel flows.
		   Don't forget it must stop when the target hash is found.
		   Use GraphElements.parallelHashFlow to create a simple Flow that holds the parallel flows.
		*/
		return null;
	}
